...
def get_cached_styles():
    ...
    .first-icon {{ font-family: 'Material Symbols Rounded'; font-size: 0.85rem; color: #245EFF; font-variation-settings: 'wght' 400, 'FILL' 1, 'opsz' 20; vertical-align: middle; line-height: 1; }}
